...
3. CUI Application Solution (version 1.0.2) - [download here](https://github.com/EmilGramDK/Aras-CUI_Application/releases/download/V1.0.2/Aras-CUI_Application_V1.0.2.zip)
