...
3. CUI Application Solution (version 1.0.1) - [download here](https://github.com/EmilGramDK/Aras-CUI_Application/releases/download/V1.0.1/Aras-CUI_Application_V1.0.1.zip)
